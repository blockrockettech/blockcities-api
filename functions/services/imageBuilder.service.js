...
class ImageBuilderService {
    ...
    async generateImageStats({
        ...
        try {
            if (parseInt(building) === 8) {
                return await this.generateNoRoofImageStats(
                    {
                        building,
                        base,
                        body,
            ...
            const adjustedBodyWidthPath = bodyConfig.anchorWidthPath * (baseConfig.anchorWidthPath / bodyConfig.width);
            const adjustedBodyWidth = bodyConfig.width * (baseConfig.anchorWidthPath / bodyConfig.width);
            const adjustedBodyAnchorX = bodyConfig.anchorX * (baseConfig.anchorWidthPath / bodyConfig.width);
    ...
    async generateNoRoofImageStats(
        ...
        try {
            ...
            return {
                adjustedBodyHeight,
                adjustedBodyWidth: bodyConfig.width,
                canvasHeight,
            };
